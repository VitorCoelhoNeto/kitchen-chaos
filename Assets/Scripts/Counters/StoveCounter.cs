...
public class StoveCounter : BaseCounter, IHasProgress
{
    ...
    {   
        ...
        // The below doesn't work because on "Interact()" it always assumes that the object will go to the Frying state first
        //FryingRecipeSO fryingRecipeSO = GetFryingRecipeSOWithInput(inputKitchenObjectSO);
        //BurningRecipeSO burningRecipeSO = GetBurningRecipeSOWithInput(inputKitchenObjectSO);
        //return (fryingRecipeSO != null) || (burningRecipeSO != null);
    }
